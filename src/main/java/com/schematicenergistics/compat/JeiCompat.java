...
public class JeiCompat implements IModPlugin {
    ...
    public ResourceLocation getPluginUid() {
        return new ResourceLocation(SchematicEnergistics.MOD_ID, "jei_plugin");
    }
    ...
    private static class SimpleClickableIngredient implements IClickableIngredient<ItemStack> {
        private final ITypedIngredient<ItemStack> typedIngredient;
        private final int x;
        private final int y;

        public SimpleClickableIngredient(ITypedIngredient<ItemStack> typedIngredient, int x, int y) {
