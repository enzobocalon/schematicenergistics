...
public record ReturnToCannonInterfacePacket(BlockPos cannonBlockPos) {

    public static ReturnToCannonInterfacePacket fromNetwork(FriendlyByteBuf buf) {
        return new ReturnToCannonInterfacePacket(buf.readBlockPos());
    }
    ...
    public static void handle(ReturnToCannonInterfacePacket packet, Supplier<NetworkEvent.Context> contextSupplier) {
